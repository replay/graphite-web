...
class BaseTagDB(object):
  ...
  def find_series(self, tags, msg_setter=None, name_setter=None, requestContext=None):
    """
  ...
  def auto_complete_tags(self, exprs, tagPrefix=None, requestContext=None):
    """
  ...
  def auto_complete_values(self, exprs, tag, valuePrefix=None, requestContext=None):
    """
